...
<div class="card">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Cédula de Identidad*</label>
    <div class="col-md-6">
      <input type="text" name="dni" value="<?php echo $user->dni;?>" required class="form-control" id="cedula" placeholder="Cédula de Identidad">
    </div>
  </div>
  <div class="form-group">
