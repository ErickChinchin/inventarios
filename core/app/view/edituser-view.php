  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <select name="kind" class="form-control">
        <option value="0" <?php if($user->kind==0) echo "selected"; ?>>Administrador</option>
        <option value="1" <?php if($user->kind==1) echo "selected"; ?>>Vendedor</option>
        <option value="2" <?php if($user->kind==2) echo "selected"; ?>>Cliente</option>
      </select>
    </div>
  </div>

  <div class="form-group">
    <label for="branch_id" class="col-lg-2 control-label">Sucursal</label>
    <div class="col-md-6">
      <select name="branch_id" class="form-control">
        <option value="">-- Ninguna --</option>
        <?php foreach(BranchData::getAllActive() as $branch): ?>
          <option value="<?php echo $branch->id; ?>" <?php if($user->branch_id == $branch->id) echo "selected"; ?>><?php echo htmlspecialchars($branch->name); ?></option>
        <?php endforeach; ?>
      </select>
    </div>
  </div>
