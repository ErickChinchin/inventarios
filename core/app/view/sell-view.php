...
<div class="form-group">
    ...
    <div class="col-lg-10">
    <?php 
$clients = PersonData::getAllActive();
    ?>
    <div class="row">
        <div class="col-md-8">
            <select name="client_id" class="form-control" id="client_select">
        ...
        <div class="col-md-4">
            <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#searchClientModal">
...
<div class="modal fade" id="searchClientModal" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="mb-3">
            ...
            <input type="text" id="dni_search" class="form-control" placeholder="Ingrese cédula de identidad...">
        </div>
...
<script>
$(document).ready(function(){
    $("#dni_search").on("keyup", function(e){
        if(e.keyCode === 13){
            searchClientByDni();
        }
    });
    $("#searchClientModal").on("click", ".select-client", function(){
