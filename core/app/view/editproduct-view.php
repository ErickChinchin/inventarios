  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      <div class="input-group">
        <input type="text" name="barcode" class="form-control" id="product_code" value="<?php echo $product->barcode; ?>" placeholder="Codigo de barras del Producto">
        <button class="btn btn-secondary" type="button" id="btn-generate-code"><i class="bi bi-shuffle"></i> Generar</button>
      </div>
    </div>
  </div>
    <div class="form-group">
...
<script>
  $(document).ready(function(){
    $("#btn-generate-code").click(function(){
      var randomCode = "750" + Math.floor(1000000000 + Math.random() * 9000000000);
