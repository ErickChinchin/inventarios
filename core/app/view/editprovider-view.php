...
<div class="row">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="ruc" value="<?php echo $user->ruc;?>" required class="form-control" id="ruc" placeholder="RUC">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Empresa*</label>
    <div class="col-md-6">
      <input type="text" name="company" value="<?php echo $user->company;?>" required class="form-control" id="company" placeholder="Nombre de empresa">
    </div>
  </div>
  <div class="form-group">
