...
<div class="form-group">
    <label for="branch_id" class="col-lg-2 control-label">Sucursal de Destino</label>
    <div class="col-lg-10">
...
$providers = PersonData::getProviders();
    ...
    <?php foreach($providers as $provider):?>
    	<option value="<?php echo $provider->id;?>"><?php echo $provider->name." ".$provider->lastname; if($provider->company){ echo " (".$provider->company.")"; } if($provider->ruc){ echo " - RUC: ".$provider->ruc; }?></option>
    <?php endforeach;?>
    	</select>
    </div>
  </div>
