...
$selected_branch_id = $curr_user ? $curr_user->branch_id : null;
...
if($q>0):?>
    ...
    <div class="col-lg-2 col-md-4 col-6 mb-3 product-item" data-description="<?php echo htmlspecialchars($product->description); ?>" data-presentation="<?php echo htmlspecialchars($product->presentation); ?>" data-barcode="<?php echo htmlspecialchars($product->barcode); ?>">
      <div class="card h-100 <?php if($q<=$product->inventary_min){ echo "border-danger"; }?>">
        ...
        <div class="card-body p-1">
          ...
          <p class="card-text mb-1 text-muted" style="font-size: 0.7rem;"><?php echo $product->description; ?></p>
          <?php endif; ?>
